                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="card shadow border-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="">
                                    <img class="rounded-2" src="https://d3cm515ijfiu6w.cloudfront.net/wp-content/uploads/2022/10/22101446/mercedes-five-stabiliser-wing-planetf1.jpg" alt="">
                                </div>
                                <div class="mt-5">
                                    <span class="h6 font-bold text-muted text-sm d-block mb-2">Mercedes-AMG Petronas W13 Front Wing</span>
                                    <span class="h3 font-bold mb-0">$750.90</span>
                                </div>
                            </div>
                            <div class="mt-2 mb-0 text-sm">
                                <span class="badge badge-pill bg-soft-secondary text-danger me-2">
                                    <i class="bi bi-clock-history me-1"></i>00:25:13s
                                </span>
